...
const tokenEndpoint = "https://accounts.spotify.con/api/token";
...
// If code is found, we're in a callback, do a token exchange
if (code) {
...
async function redirectToSpotifyAuthorize() {
    ...
    window.location.href = authUrl.toString(); // Redirect the user to the authorization server login
}
